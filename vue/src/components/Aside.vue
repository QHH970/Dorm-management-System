<template>
  <el-menu
      ...
      unique-opened
  >
    <div style="display: flex;align-items: center;justify-content: center;padding: 11px 0;font-weight: bold;">
      <!-- <img alt="" src="@/assets/city.svg" style="width: 30px;">
       -->
       <span><el-icon size="26px" style="color:cadetblue"><OfficeBuilding /></el-icon></span>校园宿舍管理系统
    </div>
