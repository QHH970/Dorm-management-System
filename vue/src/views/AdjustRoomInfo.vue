    ...
    <el-card style="margin: 15px; min-height: calc(100vh - 111px)">
      <div>
        ...
        <el-table v-loading="loading" :data="tableData" border max-height="705" style="width: 100%">
          ...
          <el-table-column label="学生账号" prop="username" sortable width="120px"/>
          ...
          <el-table-column label="操作"  min-width="270">
            <template #default="scope">
              <el-button v-if="scope.row.state==='通过' ||scope.row.state==='驳回'" icon="View" type="default"
                         @click="showDetail(scope.row)">处理详情</el-button>
              <el-button v-if="scope.row.state!=='通过' " icon="Aim" type="primary"
          ...
          <el-dialog v-model="dialogVisible" title="操作" width="30%" @close="cancel">
            <el-form ref="form" :model="form" :rules="rules" label-width="120px">
              ...
              <el-form-item label="申请状态" prop="state">
                <el-radio v-model="form.state" label="通过" value="通过">通过</el-radio>
                <el-radio  v-model="form.state" label="驳回">驳回</el-radio>
              </el-form-item>
